	...
	public CostumerFrame() {
		...
		btnsave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!ValidationUtil.validateNotEmpty("Nama", txtnama.getText())) return;
				if (!ValidationUtil.validateNotEmpty("Alamat", txtalamat.getText())) return;
				if (!ValidationUtil.validateNumber("Nomor HP", txtnomor_hp.getText())) return;
